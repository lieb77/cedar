...
cedar theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of cedar theme and run the following commands:
`nvm use`
...
`drush en cedar -y`
`drush config-set system.theme default cedar -y`
